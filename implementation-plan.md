...
3. **HA Entity Consolidation**: Connect the controller to an MQTT broker, observe HA Discovery payloads, and confirm that all entities belong to exactly _one_ unified device in Home Assistant.
