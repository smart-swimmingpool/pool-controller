...
The [Homie Convention](https://homieiot.github.io/) provides a standardized MQTT device discovery convention.
...
[Home Assistant MQTT Discovery](https://www.home-assistant.io/integrations/mqtt/#mqtt-discovery) allows automatic device discovery in Home Assistant.
...
You can set the MQTT protocol in the Homie configuration UI or in the `config.json` file:
