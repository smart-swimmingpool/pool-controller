...
- [KiCad-Schaltplan: ESP32 Dev Board](kicad/esp32-dev-board/esp32-dev-board-schematic.pdf) — PDF-Export des KiCad-9.0-Schaltplans
- [KiCad-Schaltplan: NORVI AE01-R](kicad/norvi-ae01-r/norvi-ae01-r-schematic.pdf) — PDF-Export der NORVI-Variante in KiCad 9.0
