...
Backslash-newline splicing happens BEFORE comment processing (C++ phases 2→3), so `// NOLINT \` makes
the rest of the macro body a comment, leaving the `if` body unclosed.
