...
HomieSetting<bool> LoggerNode::logserial("logserial", "log to serial");
HomieSetting<bool> LoggerNode::flushlog("flushlog",
                                         "Flush serial log after each log");
static String             loggerString;

LoggerNode::LoggerNode()
    : HomieNode("Log", "Logger", "Logger"),
      m_loglevel(DEBUG),
      logSerial(true),
      logJSON(true) {
  ...
  advertise("LogSerial")
      .settable()
      .setName("log to serial interface")
      .setDatatype("boolean");
}
