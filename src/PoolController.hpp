...
namespace PoolController {
    ...
    */
    ...
    private:
        ...
        HomieSetting<double>        poolVolumeSetting_ { "pool-volume", "Pool volume in cubic meters" };
        HomieSetting<double>        pumpCapacitySetting_ { "pump-capacity", "Pump capacity in cubic meters per hour" };
        HomieSetting<bool>          useTemperatureBasedDurationSetting_ { "use-temp-based-duration", "Use temperature-based filtration duration" };
