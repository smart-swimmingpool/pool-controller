...
// `_binary_x509_crt_bundle_start` is a linker symbol exported by the ESP-IDF
// built-in `esp_crt_bundle` component (part of mbedTLS / the espressif32
// platform package).  It is NOT generated by `board_build.embed_files`; no
// custom file embedding is required.  The component is compiled into every
// Arduino-ESP32 firmware image automatically when
// CONFIG_MBEDTLS_CERTIFICATE_BUNDLE is enabled (the default).
// The extern declaration below gives that symbol the C++ identifier
