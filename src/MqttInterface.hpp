...
inline void publishSensorDiscovery(const char *objectId, const char *name, const char *deviceClass = nullptr,
  ...
  HomeAssistant::DiscoveryPublisher::publishSensor(kDeviceId, objectId, name, deviceClass, unitOfMeasurement, icon);
}

inline void publishSwitchDiscovery(const char *objectId, const char *name, const char *icon = nullptr) {
  if (!isHomeAssistant()) {
    return;
  }
...
inline void publishTextState(const HomieNode &node, const char *homieProperty, const char *objectId, const char *value) {
  publishSensorState(const_cast<HomieNode &>(node), homieProperty, objectId, value);
}

inline void publishSwitchState(HomieNode &node, const char *homieProperty, const char *objectId, bool state) {
  if (isHomeAssistant()) {
...
inline void publishNumberState(HomieNode &node, const char *homieProperty, const char *objectId, const char *value) {
  if (isHomeAssistant()) {
...
inline void publishSelectState(HomieNode &node, const char *homieProperty, const char *objectId, const char *value) {
  if (isHomeAssistant()) {
