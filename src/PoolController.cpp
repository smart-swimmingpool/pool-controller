...
namespace PoolController {
    ...
    auto PoolControllerContext::setupHandler() -> void {
        ...
        operationModeNode.setPoolVolume(this->poolVolumeSetting_.get());
        operationModeNode.setPumpCapacity(this->pumpCapacitySetting_.get());
        operationModeNode.setUseTemperatureBasedDuration(this->useTemperatureBasedDurationSetting_.get());
    ...
    auto PoolControllerContext::setup() -> void {
        ...
        this->poolVolumeSetting_.setDefaultValue(30.0).setValidator(
        ...
        this->pumpCapacitySetting_.setDefaultValue(6.0).setValidator(
            [](const double candidate) -> bool {
                return candidate > 0 && candidate <= 100;
            }
        );
        ...
        this->useTemperatureBasedDurationSetting_.setDefaultValue(false);
