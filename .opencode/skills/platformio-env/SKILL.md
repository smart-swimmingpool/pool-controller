...
- Current Olimex local UI pin highlights: TFT MOSI/SCLK/CS/DC = GPIO18/19/21/7, TFT MISO = -1 (write-only), KY-040 CLK/DT/SW = GPIO4/5/16, DS18B20 pool = GPIO20, relays = GPIO10/11, status LED = GPIO8.
